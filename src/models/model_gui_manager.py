...
class ModelGUIManager:
    ...
    def process_images(self, image_dir_1, image_dir_2):
        """
        ...
        :return: None
        """
        self._selected_model.get_heatmap_vis(image_dir_1, image_dir_2, self._settings)
        self._dirty = False

    def get_image_2_heatmap(self, image_dir_1, image_dir_2, point):
        """
        ...
        """
        if self._dirty:
            self.process_images(image_dir_1, image_dir_2)

        return self._selected_model.get_heatmap_vis(image_dir_1, image_dir_2, point, self._settings)
