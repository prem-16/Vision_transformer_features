...
class ViTExtractor:
    ...
    def preprocess(self, image_path: Union[str, Path], **kwargs) -> Tuple[torch.Tensor, Image.Image]:
        """
        ...
        return self.preprocess_from_pil(pil_image, **kwargs)

    def preprocess_from_pil(self, pil_image: Image.Image,
