...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_dir', type=str, required=False, help='The root dir of image pairs.', default="images/test_pairs")
    parser.add_argument('--save_dir', type=str, required=False, help='The root save dir for image pairs results.', default="images/test_pairs_correspondences")
